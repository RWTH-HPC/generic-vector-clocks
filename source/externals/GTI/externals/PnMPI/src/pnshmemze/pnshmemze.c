...
#define PNMPI_LIBRARY_NAME "libpnshmem" LIB_EXTENSION
 ...
 *  \ref find_library.
 */
#define DEFAULT_FALLBACK_LIBRARY_PATH PNSHMEMZE_SEARCH_PATHS
#endif
 ...
 */
const char *argp_program_version = "P^nMPI+SHMEM " PNMPI_VERSION;

const char *argp_program_bug_address = "https://github.com/LLNL/PnMPI/issues";

static char doc[] =
  "P^nMPI+SHMEM -- Virtualization Layer for the MPI Profiling Interface";
