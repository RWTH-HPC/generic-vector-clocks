...
// CHECK: [MUST-REPORT]{{.*Typemap = {\\\\(MPI_DOUBLE, [0-9]*\\\\), \\\\(MPI_CHAR, [0-9]*\\\\)}.*Typemap = {\\\\(MPI_FLOAT, [0-9]*\\\\), \\\\(MPI_FLOAT, [0-9]*\\\\), \\\\(MPI_DOUBLE, [0-9]*\\\\), \\\\(MPI_CHAR, [0-9]*\\\\), \\\\(MPI_CHAR, [0-9]*\\\\), \\\\(MPI_CHAR, [0-9]*\\\\), \\\\(MPI_CHAR, [0-9]*\\\\)}}}
