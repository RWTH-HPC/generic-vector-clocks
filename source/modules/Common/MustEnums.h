...
#undef enum_entry_macro
		...
		MUST_WARNING_OPENSHMEM_COLLECTIVE_APPLICATION_SUBSET_WEAK_ALIGNED,
		MUST_WARNING_OPENSHMEM_COLLECTIVE_APPLICATION_SUBSET_UNALIGNED,
		MUST_WARNING_OPENSHMEM_COLLECTIVE_APPLICATION_WEAK_ALIGNED,
		MUST_WARNING_OPENSHMEM_COLLECTIVE_APPLICATION_UNALIGNED,

		//Informations
		MUST_INFO_OPENSHMEM_COLLECTIVE_APPLICATION_SUBSET_ALIGNED,
		MUST_INFO_OPENSHMEM_COLLECTIVE_APPLICATION_FULLY_ALIGNED,
